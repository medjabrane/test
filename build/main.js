...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_login__ = __webpack_require__(197);
...
var HomePage = (function () {
    function HomePage(navCtrl, signinService, toastController) {
    ...
    HomePage.prototype.onSubmit = function () {
        ...
        this.signinService.login({ "username": this.login, "password": this.mdp }).subscribe(function (token) {
            ...
            var toast = _this.toastController.create({
                message: 'Authentification succes!',
                duration: 2000
            });
            toast.present();
        }, function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"C:\Users\MedJabrane\Desktop\rimtelecom2\RimTrackApp\src\pages\home\home.html"*/`<ion-content class="page-login" padding>\n  <ion-card class="login-card">\n<style>\ndiv {\n    width: 220px;\n    padding: 10px;\n    margin: 0;\n    text-align: center;\n    margin-left: auto;\n    margin-right: auto;\n}\n</style>\n      <div>\n    <img src="assets/img/logorim.jpg" height="150" />   \n  </div>\n    <ion-card-content>\n      <ion-list >\n        <ion-item>\n          <ion-label floating>Nom d\'utilisateur</ion-label>\n          <ion-input type="text" [(ngModel)]="login" name="login"></ion-input>\n        </ion-item>\n        <ion-item>\n          <ion-label floating>Mot de passe</ion-label>\n          <ion-input type="password" [(ngModel)]="mdp" name="mdp"></ion-input>\n        </ion-item>\n      </ion-list >\n      <button  margin-top ion-button margin-right block width-50 icon-left (click)=onSubmit()>\n        <ion-icon name="log-in"></ion-icon>\n         Se connecter\n      </button>\n    </ion-card-content>\n  </ion-card>\n</ion-content>`/*ion-inline-end:"C:\Users\MedJabrane\Desktop\rimtelecom2\RimTrackApp\src\pages\home\home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__providers_login__["a" /* Login */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* ToastController */]])
    ], HomePage);
    return HomePage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__global_config__ = __webpack_require__(274);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_headers__ = __webpack_require__(275);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_login__ = __webpack_require__(197);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_8__providers_login__["a" /* Login */],
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\MedJabrane\Desktop\rimtelecom2\RimTrackApp\src\app\app.html"*/`<ion-nav [root]="rootPage"></ion-nav>\n`/*ion-inline-end:"C:\Users\MedJabrane\Desktop\rimtelecom2\RimTrackApp\src\app\app.html"*/
        }),
...
/* unused harmony export imagesDir */
/* unused harmony export nominatim_dns */
